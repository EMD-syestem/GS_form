...
function playWelcomeVoice() {
  ...
  speak(
    "Selamat datang di Reservasi Kendaraan General Service Pertamina Field Jambi."
  );
...
if (SpeechRecognition) {
  ...
  recognition.onstart = () => {
    ...
    console.log("Voice Assistant Aktif");
...
function takeCommand(message) {
  ...
  if (message.includes("hey") || message.includes("hello")) {
    ...
    speak("Hello, bagaimana saya dapat membantu Anda?");
    ...
    console.log("Perintah tidak dikenali :", message);
